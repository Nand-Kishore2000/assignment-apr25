  ...
  const {searchQuery, setSearchQuery } = useSearch();
    ...
    return (
      <div className="border-b-[1px] py-20 h-[80px] shadow-lg pl-4 pr-4 text-[20px] font-bold  border-white w-full bg-white flex justify-evenly align-middle items-center">
        ...
        <div className="pl-[20px] rounded-[20px] border-[1px] h-[45px] w-[500px]  pr-[10px] justify-between flex align-middle items-center">
          <input
            type="text"
            name="search"
            ...
            className=" p-8 pl-[10px] text-[18px] border-none w-full  rounded-[20px] border-white outline-none"
          />
